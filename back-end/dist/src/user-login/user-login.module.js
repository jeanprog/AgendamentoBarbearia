...
exports.UserLoginModule = UserLoginModule = __decorate([
    (0, common_1.Module)({
        imports: [prisma_module_1.PrismaModule],
        controllers: [user_login_controller_1.UserLoginController],
        providers: [user_login_service_1.UserLoginService, prisma_service_1.PrismaService, password_service_1.PasswordService],
    })
], UserLoginModule);
